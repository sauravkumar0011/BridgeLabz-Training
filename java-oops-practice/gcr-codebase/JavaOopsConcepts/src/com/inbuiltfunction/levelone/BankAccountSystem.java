...
public class BankAccountSystem {
	...
	public static void main(String[] args) {
		...
		BankAccountSystem account1 = new BankAccountSystem("Lynda Princy", "ACC12345", 1000.00);
		BankAccountSystem account2 = new BankAccountSystem("Prince Danish", "ACC67890", 500.00);
